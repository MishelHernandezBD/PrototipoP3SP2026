...
public class BitacoraDAO {
    ...
    public clsBitacora queryPorCodigo(clsBitacora bitacora) {
        ...
        try {
            ...
            if (rs.next()) {
                resultado = new clsBitacora();
                resultado.setBitcodigo(rs.getInt("Bitcodigo"));
                resultado.setUsucodigo(rs.getInt("Usuid"));
                resultado.setAplcodigo(rs.getInt("Aplcodigo"));
                resultado.setBitfecha(rs.getString("Bitfecha")); 
                resultado.setBitip(rs.getString("Bitip"));
                resultado.setBitequipo(rs.getString("Bitequipo"));
                resultado.setBitaccion(rs.getString("Bitaccion"));
            }
        } catch (SQLException ex) {
            ex.printStackTrace(System.out);
        } finally {
