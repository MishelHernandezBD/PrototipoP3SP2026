...
public class MdiSeguridad extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem3.setText("Examen");
        jMenuItem3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem3ActionPerformed(evt);
            }
        });
        jMenuExamen.add(jMenuItem3);

        mnuGeneral.add(jMenuExamen);
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
                // TODO add your handling code here:
        System.out.println("entre a mantenimiento tipoPuesto");
        TipoPuesto ventana = new TipoPuesto();
        jDesktopPane1.add(ventana);
        Dimension desktopSize = jDesktopPane1.getSize();
        Dimension FrameSize = ventana.getSize();
        ventana.setLocation((desktopSize.width - FrameSize.width) / 2, (desktopSize.height - FrameSize.height) / 2);
